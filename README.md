...
**Optional**: The CLI [version](https://github.com/mobile-dev-inc/Maestro/releases). Defaults to [`2.8.0`](https://github.com/mobile-dev-inc/Maestro/releases/tag/cli-2.8.0):
