...
**Optional**: The CLI [version](https://github.com/mobile-dev-inc/Maestro/releases). Defaults to [`2.6.1`](https://github.com/mobile-dev-inc/Maestro/releases/tag/cli-2.6.1):
